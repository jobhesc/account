...
public class BASE64Encoder extends CharacterEncoder
	{
	    ...
	    throws IOException
	  {
	    if (paramInt2 == 1)
	    {
	      ...
	      paramOutputStream.write(pem_array[(0x3F & i2 >>> 2)]);
	      paramOutputStream.write(pem_array[(0 + (0x30 & i2 << 4))]);
	    ...
	    if (paramInt2 == 2)
	    {
	      int l = paramArrayOfByte[paramInt1];
	      int i1 = paramArrayOfByte[(paramInt1 + 1)];
	      paramOutputStream.write(pem_array[(0x3F & l >>> 2)]);
	      paramOutputStream.write(pem_array[((0x30 & l << 4) + (0xF & i1 >>> 4))]);
	      paramOutputStream.write(pem_array[(0 + (0x3C & i1 << 2))]);
	      paramOutputStream.write(61);
	      return;
	    }
