...
public class ReportLRBActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.report_lrb);
		
		reportView = (ReportView)findViewById(R.id.report_lrb_view);
		...
		txtPeriodView.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				if(event.getAction() == MotionEvent.ACTION_UP){
					...
					UIHelper.showDatePickerDialog(ReportLRBActivity.this, dateFormat, txtPeriodView);
				}
				return true;
			}
		});
